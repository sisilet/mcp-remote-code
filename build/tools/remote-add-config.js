import { z } from "zod";
export function createRemoteAddConfigTool(server, connectionManager) {
    server.tool("remote_add_config", "Add a new remote machine configuration template. This only saves the config, it does not connect.", {
...
//# sourceMappingURL=remote-add-config.js.map